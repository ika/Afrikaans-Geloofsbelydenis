...
class MainDetailPage extends StatefulWidget {
  MainDetailPage(int indx, {Key? key}) : super(key: key) {
    index = indx;
  }

  @override
  MainDetailPageState createState() => MainDetailPageState();
}

class MainDetailPageState extends State<MainDetailPage> {
